...
class BBOBB : public AlgoLayer {
 ...
 private:
  ...
  /**
   * @brief Method called to see if current participant is late in processing
   * received step messages.
   */
   ...
   * peer will connect to and also the number of peers which will connect to
   * this peer.
   */
  int nbStepsInWave{0};
