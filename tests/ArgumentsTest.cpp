...
namespace fbae_test_arguments {
    ...
    TEST_F(ArgumentsTest, algoArgumentFound) {
        Arguments arguments{ sites, "anotherArgument=42,trainsNb=4,yetAnotherArgument=43", ""};
    ...
    TEST_F(ArgumentsTest, algoArgumentNotFound) {
        ...
        EXPECT_EQ(expectedTrainsNb, arguments.getIntInAlgoArgument("trainsNb", expectedTrainsNb));
    }
    ...
    TEST_F(ArgumentsTest, commArgumentFound) {
        Arguments arguments{ sites, "", "anotherArgument=42,tcpMaxSizeForOneWrite=32768,yetAnotherArgument=43"};
        EXPECT_EQ(expectedTcpMaxSizeForOneWrite, arguments.getIntInCommArgument("tcpMaxSizeForOneWrite", 0));
    }

    TEST_F(ArgumentsTest, commArgumentNotFound) {
        Arguments arguments{ sites, "", "nonsense=32768"};
        EXPECT_EQ(expectedTcpMaxSizeForOneWrite, arguments.getIntInCommArgument("tcpMaxSizeForOneWrite", expectedTcpMaxSizeForOneWrite));
    }
