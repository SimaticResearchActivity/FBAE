...
#
get_filename_component(filename "/home/thomas/Documents/Travail/FBAE/build/yoctolib_cpp-download/yoctolib_cpp-prefix/src/v2.0.59526.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/thomas/Documents/Travail/FBAE/build/yoctolib_cpp-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-yoctolib_cpp${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-yoctolib_cpp${i}")
