...
#
get_filename_component(filename "/home/thomas/Documents/Travail/FBAE/build/cereal-download/cereal-prefix/src/v1.3.2.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/thomas/Documents/Travail/FBAE/build/cereal-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-cereal${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-cereal${i}")
